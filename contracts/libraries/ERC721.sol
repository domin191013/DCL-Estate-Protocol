...
library ERC721 {
    ...
    bytes32 constant ERC721_STORAGE_POSITION =
        keccak256("com.dcl.estate.erc721");
    ...
    function exists(uint256 tokenId) internal view returns (bool) {
        return ERC721.erc721Storage().owners[tokenId] != address(0);
    }
     ...
     *
     * See {xref-ERC721-safeMint-address-uint256-}[`safeMint`]
     */
    ...
    function burn(uint256 tokenId) internal {
        ...
        ERC721Storage storage erc721 = ERC721.erc721Storage();
