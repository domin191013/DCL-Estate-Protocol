...
interface IMarketplaceFacet is IRentable {
    ...
    /**
     * @dev Transfers and locks the provided metaverse asset to the contract, and mints an asset representing the locked asset.
     ...
     * @param _maxFutureTime The timestamp delta after which the protocol will not allow the asset to be rented at an any given moment.
    ...
    /**
     * @dev Updates the lending conditions for a given asset.
     * Pays out any unclaimed rent to consumer if set, otherwise it is paid to the owner of the DCL Estate NFT
    ...
    /**
     * @dev Delists the asset from the marketplace, If there are no active rents:
    ...
    /**
     * @dev Withdraws the already delisted from marketplace asset.
     * Burns the asset and transfers the original metaverse asset represented by the asset to the asset owner.
     * Pays out any unclaimed rent to consumer if set, otherwise it is paid to the owner of the DCL Estate NFT
    ...
    /**
     * @dev Rents an asset for a given period.
    ...
    /**
     * @dev Sets name for a given Metaverse.
    ...
    /**
     * @dev Sets Metaverse registry to a Metaverse
     * @param _metaverseId The target metaverse
    ...
    /**
     * @dev Gets the name of the Metaverse
     * @param _metaverseId The target metaverse
     */
    ...
    /**
     * @dev Get whether the registry is supported for a metaverse
     * @param _metaverseId The target metaverse
    ...
    /**
     * @dev Gets the total amount of registries for a metaverse
     * @param _metaverseId The target metaverse
     */
    ...
    /**
     * @dev Gets a metaverse registry at a given index
     * @param _metaverseId The target metaverse
    ...
    /**
     * @dev Gets all asset data for a specific asset
     * @param _assetId The target asset
     */
    ...
    /**
     * @dev Gets all data for a specific rent of an asset
